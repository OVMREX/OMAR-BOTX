let handler = async (m, { conn, args, text, usedPrefix, command }) => {
	...
	switch (type) {
	  case 'gfx1':
		...
		conn.sendFile(m.chat, chut, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m);
		m.react(done);
		break;
	  ...
	  case 'gfx2': 
		...
		conn.sendFile(m.chat, loda, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m);
	  ...
	  case 'gfx3':
		...
		conn.sendFile(m.chat, cp, 'logo.png', ` https://www.instagram.com/ovmar_1`, m);
		m.react(done);
		break;
	  ...
	  case 'gfx4': 
		...
		conn.sendFile(m.chat, gandu, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m);
		m.react(done);
		break;
		case 'gfx5':
    if (!text) throw tee
    const apiUrll = `https://api.lolhuman.xyz/api/textprome/jokerlogo?apikey=${lolkeysapi}&text=${encodeURIComponent(text)}`;
    conn.sendFile(m.chat, apiUrll, 'logo.png', '✅ https://www.instagram.com/ovmar_1', m);
    m.react('✅');
    break;
	...
	conn.sendFile(m.chat, apiUrl, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m)
	m.react(done)
	break 
	case 'gfx7': 
	if (!text) throw too;
	...
	conn.sendFile(m.chat, oda, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m);
	...
	conn.sendFile(m.chat, rand, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m);
	m.react(done);
	break;
	case 'gfx9': 
	if (!text) throw tee;
	let randi = `https://api.lolhuman.xyz/api/ephoto1/avatarlolnew?apikey=${lolkeysapi}&text=${encodeURIComponent(text)}`;
	conn.sendFile(m.chat, randi, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m);
	m.react(done);
	break;
	case 'gfx10': 
	if (!text) throw tee;
	let randu = `https://api.lolhuman.xyz/api/ephoto1/avatardota?apikey=${lolkeysapi}&text=${encodeURIComponent(text)}`;
	conn.sendFile(m.chat, randu, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m);
	m.react(done);
	break;
	case 'gfx11': 
	if (!text) throw too;
	...
	conn.sendFile(m.chat, od, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m);
	...
	conn.sendFile(m.chat, rr, 'logo.png', `✅ https://www.instagram.com/ovmar_1`, m);
	m.react(done);
	break;
