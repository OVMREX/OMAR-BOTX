...
let handler = async (m, { conn }) => {
  ...
  try {
    let repo_Data = await axios.get('https://api.github.com/repos/OVMREX/OMAR-BOTX);
    let { stargazers_count, forks, owner, created_at, html_url } = repo_Data.data;

    let infobt = `
 *I'm OMAR BOT.* *A WhatsApp chuddy buddy bot with rich features* *Created By OMAR.
 ...
 *❲❒❳ Repo:* ${html_url}
 *❲❒❳ Scan:* 
 *❲❒❳ Visit For Tutorial:* https://www.instagram.com/ovmar_1
